...
_smtp_message_add_recipient_from_template(smtp_message_t self, AFSMTPDriver *driver, LogTemplate *template,
                                          LogMessage *msg)
{
  log_template_format(template, msg, &driver->template_options, NULL, LTZ_SEND,
...
afsmtp_dd_msg_add_header(AFSMTPHeader *hdr, gpointer user_data)
{
  ...
  log_template_format(hdr->template, msg, &self->template_options, NULL, LTZ_LOCAL,
...
__build_message(AFSMTPDriver *self, LogMessage *msg, smtp_session_t session)
{
  ...
  log_template_format(self->mail_from->template, msg, &self->template_options, NULL, LTZ_SEND,
                      self->super.seq_num, NULL, self->str);
  ...
  log_template_format(self->subject_template, msg, &self->template_options, NULL, LTZ_SEND,
                      self->super.seq_num, NULL, self->str);
  ...
  log_template_append_format(self->body_template, msg, &self->template_options, NULL,
